 ...
 */
fun myProfile() {
    var firstName: String = "Mikais"
    var lastName: String = "Rizki Triwan"
    var age: Byte = 20

    var tidak: Boolean = true
 ...
 */
fun myGroup(): String {
    val listMembers = arrayOf("Peja", "Adi", "Ananda", "Kepin", "Mikais")
    var members: String = ""
    for (i in 0..listMembers.size - 1) {
        members += "\n" + (i + 1) + "." + listMembers[i]
    }
    return members
...
fun main() {
     ...
     *
     */
    groupDetail(1, listOf("Peja", "Adi", "Ananda", "Kepin", "Mikais"), "Afternoon")
